        ...
        public void Parse(IBitStream bitstream, DemoParser parser)
        {
            ...
            while (!bitstream.ChunkFinished)
            {
                ...
                else if (wireType == 2 && fieldnum == 3)
                {
                    ...
                    {
                        case 1: // string
                            if (wireType != 2) throw new InvalidDataException("proto definition differs");

                            Keys.Add(bitstream.ReadProtobufString());
                            break;
                        case 2: // float
                            if (wireType != 5) throw new InvalidDataException("proto definition differs");
                        ...
                        case 4: // short
                        case 5: // byte
                            if (wireType != 0) throw new InvalidDataException("proto definition differs");
                    ...
                    if (!bitstream.ChunkFinished) throw new InvalidDataException("Lord Gaben tricked us! D:");
