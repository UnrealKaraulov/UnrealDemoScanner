                        ...
                        default:
                            {
                                ...
                                BadPunchAngle = abs(nf.RParms.Punchangle.Z) > EPSILON/* ||
...
* */
        ...
        {
            float duration = UnFixedUnsigned16(BitBuffer.ReadUInt16());
            float holdTime = UnFixedUnsigned16(BitBuffer.ReadUInt16());
