namespace DemoScanner.ValvePak
{
    public class PackageEntry
    {
        ...
        {
            if (DirectoryName == " ") return GetFileName();
        ...
        {
            return
                $"{GetFullPath()} crc=0x{CRC32:x2} metadatasz={SmallData.Length} fnumber={ArchiveIndex} ofs=0x{Offset:x2} sz={Length}";
        }
    }
}