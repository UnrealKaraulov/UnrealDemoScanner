...
waveFormatHeader_t* stereo16bit8khzWaveHeaderForLength(uint32_t numberOfFrames) {
    waveFormatHeader_t* wh = stereo16bit8khzWaveHeader();
...
waveFormatHeader_t * stereo16bit8khzWaveHeader(){
